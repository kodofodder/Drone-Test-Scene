...
public class DroneController : MonoBehaviour {
	...
	void Start () {
		...
		propellers[0] = GameObject.Find ("FLpropeller");
		propellers[1] = GameObject.Find ("FRpropeller");
		propellers[2] = GameObject.Find ("RLpropeller");
		propellers[3] = GameObject.Find ("RRpropeller");
	...
	void ApplyForcesTorque() {
		...
		float maxForce = 0.0f;
		for (int i = 0; i < 4; ++i) {
			propellerUp = propellers [i].transform.up;
